...
//       setBlogs(blogData || []); // fallback to empty array
//     } catch (err) {
//       console.error("Error fetching blogs:", err);
//       setBlogs([]); // avoid crash
//     }
//   }
//   loadBlogs();
// }, []);
...
// import finLog from '../../assets/logo_fin.png';
// import phot from '../../assets/yash.png';

// // Remove this import if you want to load blogs only from fetchBlogs
// // import blogData from '../../data/blogs.json';
...
// const BlogCard = ({ blog }) => (
//   <motion.div
//     className={`blog-card ${blog.Featured === "Yes" ? 'featured' : ''}`}
//     initial={{ opacity: 0, y: 60 }}
//     whileInView={{ opacity: 1, y: 0 }}
//     transition={{ duration: 0.6 }}
//     viewport={{ once: true }}
...
//     <div className="blog-card-header">
//       <FaMediumM size={24} className="blog-icon" />
//       {blog.Featured === "Yes" && <span className="blog-featured">🔥 Featured</span>}
//     </div>
//     <h3 className="blog-title">{blog.Title}</h3>
//     <p className="blog-desc">{blog.Description}</p>
//     {/* <div className="blog-tags">
