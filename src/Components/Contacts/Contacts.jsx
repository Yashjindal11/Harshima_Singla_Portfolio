...
export default function ContactPro() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const saved = await logMessageSubmission(form);
      if (saved) {
        setStatus("success");
        setForm({ name: "", email: "", message: "" });
        setTouched({});
        ...
        <div className="side info">
          ...
          <div className="cards">
            <motion.div className="card" whileHover={{ scale: 1.03 }}>
              <FaEnvelope className="icon" />
              <a
                href="mailto:harshima.singla26@gmail.com"
                onClick={() => logemailClick("harshima.singla26@gmail.com")}
              >
                harshima.singla26@gmail.com
              </a>
            </motion.div>
